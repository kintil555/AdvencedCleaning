...
async function loadDashboard() {
  ...
  if (gpuCard) gpuCard.textContent = si.gpuName + (si.vram ? ` — ${si.vram}` : '');

  const tempCard = document.getElementById('si-cputemp');
  if (tempCard) tempCard.textContent = si.cpuTemp !== 'N/A' ? `${si.cpuTemp}°C` : 'N/A (WMI unavailable)';
...
// ═══════════════════════════════════════════════════════════════════
//  INIT — semua addEventListener dipasang setelah DOM ready
// ═══════════════════════════════════════════════════════════════════
window.addEventListener('DOMContentLoaded', () => {

  // ── Layout: wrap sidebar + content ──────────────────────────────
